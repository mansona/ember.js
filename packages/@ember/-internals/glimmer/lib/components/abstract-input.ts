...
export default abstract class AbstractInput
  ...
  set modernized(value: boolean) {
    this._modernized = value;
  }
...
export function handleDeprecatedFeatures(
  ...
  if (SEND_ACTION) {
    ...
    prototype['listenerFor'] = function listenerFor(
      this: AbstractInput,
      name: string
    ): EventListener {
  ...
  if (EMBER_MODERNIZED_BUILT_IN_COMPONENTS) {
...

    {
      ...
      prototype['isVirtualEventListener'] = function isVirtualEventListener(
        this: AbstractInput,
        name: string,
        listener: Function
